import{j as e}from"./vendor-gzd0YkcT.js";import{v as a,c as i,b as s,a as l,l as o}from"./wii-DQmNimJC.js";import{w as d}from"./main-DHkcZIrF.js";import"./main-CaDHuGvV.js";const u=()=>`
  <div class="acerca_container">
    ...
    <div class="acerca_section">
      <h2 class="section_title">
        <i class="fas fa-info-circle"></i> Acerca de ${i}
      </h2>
      <div class="section_content">
        <p><strong>${i}</strong> es un centro multimedia moderno y profesional que integra tres reproductores especializados en una sola plataforma. Lanzado en ${s}, nace con la misión de ofrecer una <strong>experiencia multimedia completa, privada y sin límites</strong>.</p>
        <p>Con reproductores dedicados para <strong>videos, audios e imágenes</strong>, ${i} te permite disfrutar de tus archivos multimedia con controles avanzados, diseño elegante y funcionalidades profesionales como slideshow, zoom inteligente, visualización de ondas de audio en tiempo real y mucho más.</p>
    ...
    <div class="acerca_section">
      <h2 class="section_title">
        <i class="fas fa-lightbulb"></i> ¿Por qué ${i}?
      </h2>
    ...
    <div class="acerca_section">
      ...
      <div class="version_timeline">
        <div class="version_item">
          <div class="version_badge current">${a}</div>
          <div class="version_content">
            <h3>Versión ${a} - Lanzamiento Multimedia</h3>
      ...
      <div class="developer_card">
        ...
        <div class="developer_info">
          ...
          <div class="developer_links">
            <a href="${o}" target="_blank" class="dev_link">
    ...
    <div class="acerca_footer">
      ...
      <div class="footer_info">
        <p>© ${s} ${i}. Hecho con <i class="fas fa-heart"></i> por ${l}</p>
        <p class="footer_version">Versión actual: <strong>${a}</strong></p>
      </div>
    </div>
  </div>
`,f=()=>{e(".copy_email").on("click",function(){const c=e(this).data("email");d(c,this,"¡Email copiado!")}),console.log(`✅ Acerca de ${i} ${a} cargado`)},p=()=>{e(".copy_email").off(),console.log("🧹 Acerca limpiado")};export{p as cleanup,f as init,u as render};
