import{j as i}from"./vendor-gzd0YkcT.js";import{c as e,v as f}from"./wii-DQmNimJC.js";import{a as p,c as u}from"./main-DHkcZIrF.js";import"./main-CaDHuGvV.js";const g=()=>`
  <div class="inicio_container">
    ...
    <section class="benefits">
      <h2 class="section_title">
        <i class="fas fa-star"></i> ¿Por qué elegir ${e}?
      </h2>
    ...
    <section class="cta">
      <div class="cta_content">
        ...
        <p>Únete a <strong>+2,500 usuarios</strong> que ya usan ${e} diariamente</p>
    ...
    <div class="modalBody" style="background:var(--wb);max-width:800px">
      ...
      <div style="padding:3vh 2vw;font-family:var(--ff_P)">
        <h2 style="color:var(--tx);margin-bottom:2vh;text-align:center">
          <i class="fas fa-video" style="color:var(--mco)"></i> Demo de ${e}
        </h2>
...
`,y=()=>{i("#btnDemo").on("click",()=>{p("modalDemo")}),i(".modalX").on("click",function(){u("modalDemo")});const n=()=>{i(".stat_number").each(function(){const s=i(this),a=parseInt(s.data("count")),r=2e3,d=60,l=a/d;let t=0;const v=setInterval(()=>{t+=l,t>=a?(s.text(a.toLocaleString()),clearInterval(v)):s.text(Math.floor(t).toLocaleString())},r/d)})},c=new IntersectionObserver(s=>{s.forEach(a=>{a.isIntersecting&&(n(),c.disconnect())})},{threshold:.3}),o=document.querySelector(".stats_section");o&&c.observe(o),console.log(`✅ Inicio ${e} ${f} cargado`)},x=()=>{i("#btnDemo, .modalX").off(),console.log("🧹 Inicio limpiado")};export{x as cleanup,y as init,g as render};
