import{j as t}from"./vendor-gzd0YkcT.js";import{c as i,d as o,e as f,v as h}from"./main-D7tVh7M4.js";import"./main-CLK08isc.js";const b=()=>`
...
`,_=()=>{t("[data-modal]").on("click",function(){const a=t(this).data("modal");o("modalRegister"),o("modalLogin"),f(a)}),t(".modalX").on("click",function(){t(this).closest(".wiModal").attr("id",(a,s)=>(o(s),s))});const c=()=>{t(".stat_number").each(function(){const a=t(this),s=parseInt(a.data("count")),n=2e3,d=60,v=s/d;let e=0;const u=setInterval(()=>{e+=v,e>=s?(a.text(s.toLocaleString()),clearInterval(u)):a.text(Math.floor(e).toLocaleString())},n/d)})},l=new IntersectionObserver(a=>{a.forEach(s=>{s.isIntersecting&&(c(),l.disconnect())})},{threshold:.3}),r=document.querySelector(".social_proof");r&&l.observe(r),console.log(`✅ Descubre ${i} ${h} cargado - Marketing multimedia activado`)},y=()=>{t("[data-modal], .modalX").off(),console.log("🧹 Descubre limpiado")};export{y as cleanup,_ as init,b as render};
