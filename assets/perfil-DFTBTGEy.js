import{j as i}from"./vendor-gzd0YkcT.js";import{db as d}from"./firebase-DhO3Ixe7.js";import{k as u,d as _}from"./firebase-CGAbnnJF.js";import{i as m,g as c,r as v,s as b,M as e,w as h}from"./main-BYYkT38H.js";const l=()=>m("wiSmile")||{},D=()=>{const a=l();if(!a.email)return location.replace("/"),"";const s=a.nombre||"",r=a.apellidos||"",p=a.usuario||"",f=a.email||"",o=a.rol||"smile",n=a.uid||"",t=a.imagen||"./smile.avif";return((s[0]||"")+(r[0]||"")).toUpperCase(),`
  <div class="prf_wrap">
