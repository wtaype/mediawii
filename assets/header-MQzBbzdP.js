const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/login-WFAU_9EV.js","assets/vendor-gzd0YkcT.js","assets/firebase-DhO3Ixe7.js","assets/main-BYYkT38H.js","assets/firebase-CGAbnnJF.js","assets/login-pzxUIRzl.css"])))=>i.map(i=>d[i]);
import{M as l,h as t,r as c,_ as n}from"./main-BYYkT38H.js";import{j as s}from"./vendor-gzd0YkcT.js";const e=a=>{l("Bienvenido "+a.nombre),s(".nv_right").html(`
  ...
  `)};t.on(a=>a?e(a):(r(),c.navigate("/")));const i=t.user;i?e(i):r();const p=["wiTema","wiSmart","wiFresh"];s(document).on("click.hdr",".bt_salir",async()=>{const{salir:a}=await n(async()=>{const{salir:o}=await import("./login-WFAU_9EV.js");return{salir:o}},__vite__mapDeps([0,1,2,3,4,5]));a(p)});n(()=>import("./login-WFAU_9EV.js"),__vite__mapDeps([0,1,2,3,4,5]));export{e as personal};
