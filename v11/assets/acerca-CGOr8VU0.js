import{j as s}from"./vendor-gzd0YkcT.js";import{v as e,c as i,b as a,a as l,l as c}from"./wii-BfcBF13g.js";import{w as d}from"./main-CRuECGBs.js";import"./main-Do9n7hkZ.js";const p=()=>`
  <div class="acerca_container">
    ...
    <div class="acerca_section">
      ...
      <div class="section_content">
        <p><strong>${i}</strong> es un centro multimedia moderno y profesional que integra tres reproductores especializados en una sola plataforma. Lanzado en ${a}, nace con la misión de ofrecer una <strong>experiencia multimedia completa, privada y sin límites</strong>.</p>
      ...
      <div class="developer_card">
        ...
        <div class="developer_info">
          ...
          <div class="developer_links">
            <a href="${c}" target="_blank" class="dev_link">
    ...
    <div class="acerca_footer">
      ...
      <div class="footer_info">
        <p>© ${a} ${i}. Hecho con <i class="fas fa-heart"></i> por ${l}</p>
        <p class="footer_version">Versión actual: <strong>${e}</strong></p>
      </div>
    </div>
  </div>
`,u=()=>{s(".copy_email").on("click",function(){const o=s(this).data("email");d(o,this,"¡Email copiado!")}),console.log(`✅ Acerca de ${i} ${e} cargado`)},f=()=>{s(".copy_email").off(),console.log("🧹 Acerca limpiado")};export{f as cleanup,u as init,p as render};
